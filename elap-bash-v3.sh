# copyright: 1997-2022 - Felix Hauri - F-Hauri.ch
#    Licensed by GNU GENERAL PUBLIC LICENSE Version 3
#    https://www.gnu.org/licenses/gpl-3.0.txt
#
# This version of script obtained from https://f-hauri.ch/vrac/elap-bash-v3
# with copyright notice gleaned from https://f-hauri.ch/vrac/
#
